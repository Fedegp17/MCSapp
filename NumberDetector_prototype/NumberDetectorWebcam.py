...
def identify_number(img, x):
    ...
    type"""
    imagen_procesada = cv2.threshold(imagen_gris, 185, 255, cv2.THRESH_BINARY)[1]
...
imagen = cv2.imread('Imagenes/opencv_frame_3.png')
...
imagen_cortada1 = imagen[20: 60, 375: 420]
imagen_cortada2 = imagen[55: 100, 370: 420]
imagen_cortada3 = imagen[100: 140, 370: 420]
imagen_cortada4 = imagen[130: 160, 130: 163]
imagen_cortada5 = imagen[130: 160, 165: 195]
...
x1 = identify_number(imagen_cortada1, '--psm 10')
x2 = identify_number2(imagen_cortada2, '--psm 10')
x3 = identify_number2(imagen_cortada3, '--psm 10')
x4 = identify_number2(imagen_cortada4, '--psm 9')
x5 = identify_number2(imagen_cortada5, '--psm 10')
