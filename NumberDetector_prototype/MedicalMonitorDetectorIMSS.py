...
After running this code, we now know that the image is 1351 x 1500 pxls
...
# cv2.imshow("imgen cortada 4", pressure_systolic_img)
# cv2.imshow("imgen cortada 5", pressure_diastolic_img)
# cv2.waitKey(0)
