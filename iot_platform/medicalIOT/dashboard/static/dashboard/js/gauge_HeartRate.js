...
const gaugeChartTextHeart = {
    id: 'gaugeChartTextHeart',
...
const configHeartRate = {
  ...
  plugins: [gaugeChartTextHeart]
};

// render init block
const myChartHeartRate = new Chart(
  document.getElementById('myChartHeartRate'),
  configHeartRate
);
